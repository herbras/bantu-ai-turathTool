...
class IslamicSemanticChunking(SemanticChunking):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(
            chunk_size=kwargs.get('chunk_size', 3000),  # Smaller chunks for context limits
            similarity_threshold=kwargs.get('similarity_threshold', 0.6),  # Higher threshold to keep related Islamic concepts together
...
class IslamicAgenticChunking(AgenticChunking):
    ...
    def __init__(self, **kwargs):
        super().__init__(
            max_chunk_size=kwargs.get('max_chunk_size', 3000),  # Smaller for context limits
        )
